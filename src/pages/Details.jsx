...
const [isModal, setIsModal] = useState(false)
  ...
  return (
    <div>
      ...
      <section className="flex items-center gap-22">
        <div
          style={{ backgroundImage: `url(${appart?.image})` }}
          className={`relative rounded-2xl bg-cover bg-center w-209.75 h-167.5 `}
        >
          <button
...
font-normal flex gap-1 items-center"
          ...
          <Button handleClick={() => setIsModal(true)} color={"gray"}>ლისტინგის წაშლა</Button>
