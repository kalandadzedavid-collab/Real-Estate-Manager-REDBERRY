...
const ListingCard = ({ data }) => {
  return (
    ...
    <div className="relative cursor-pointer overflow-hidden w-94 shadow-[5px_5px_12px_0px_rgba(2,21,38,0.08)] rounded-2xl">
      <img className="w-full h-77 bg-cover" src={data?.image} alt="" />
      <button
        className="py-1.5 cursor-pointer absolute left-5.75 top-5.75 w-24 bg-slate-900/50 rounded-2xl text-white
text-xs
font-medium"
      >
        {" "}
...
font-normal"
        ...
        <div
          className="flex items-center gap-8 text-slate-900/70
text-base
font-normal"
        >
          <p className="flex items-center gap-[2.5px] ">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
